<template>
  <nav>
    <menu-button @click="toggleCamera()" size="sm">
    ...
    <menu-button @click="takePhotoWithTimer()">
      3s
    </menu-button>
    <menu-button @click="clear()" size="sm">
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="icon">
